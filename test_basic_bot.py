"""
Test the basic AI Meeting Assistant without optional dependencies.
"""
import argparse
import os
import sys
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test Basic AI Meeting Assistant")
    ...
    # Disable features that require optional dependencies
